...
import es.curso.miproyecto.config.Constants;
import es.curso.miproyecto.domain.Authority;
import es.curso.miproyecto.domain.User;
import es.curso.miproyecto.repository.AuthorityRepository;
import es.curso.miproyecto.repository.UserRepository;
import es.curso.miproyecto.security.AuthoritiesConstants;
import es.curso.miproyecto.service.MailService;
import es.curso.miproyecto.service.UserService;
import es.curso.miproyecto.service.dto.PasswordChangeDTO;
import es.curso.miproyecto.service.dto.UserDTO;
import es.curso.miproyecto.web.rest.errors.ExceptionTranslator;
import es.curso.miproyecto.web.rest.vm.KeyAndPasswordVM;
import es.curso.miproyecto.web.rest.vm.ManagedUserVM;
