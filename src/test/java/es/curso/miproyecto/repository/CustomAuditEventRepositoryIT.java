...
import es.curso.miproyecto.config.audit.AuditEventConverter;
import es.curso.miproyecto.domain.PersistentAuditEvent;
...
import static es.curso.miproyecto.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
